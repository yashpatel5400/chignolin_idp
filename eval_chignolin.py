...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/home/yppatel/misc/chignolin_idp/data/PPORecurrentAgent-continued_updated_train_chignolin-420000.model', map_location=device))
